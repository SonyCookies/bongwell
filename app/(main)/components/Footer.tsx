        ...
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          ...
          <div className="mt-12 grid grid-cols-2 gap-8 xl:mt-0 xl:col-span-2">
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                <h3 className="text-sm font-semibold text-[#00a5b5] tracking-wider uppercase">Solutions</h3>
              ...
              <div className="mt-12 md:mt-0">
                <h3 className="text-sm font-semibold text-[#00a5b5] tracking-wider uppercase">Company</h3>
                <ul className="mt-4 space-y-4">

                  <li>
                    <Link href="/projects" className="text-base text-gray-400 hover:text-white">
                      Projects
                    </Link>
                  </li>
                  <li>
